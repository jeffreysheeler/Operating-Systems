...
(function (TSOS) {
    var DeviceDriverFileSystem = (function (_super) {
        ...
        DeviceDriverFileSystem.prototype.writeFile = function (fileName, writeData) {
            var file = this.fillBlock(TSOS.Utils.hexFromString(fileName));
        ...
        DeviceDriverFileSystem.prototype.deleteFile = function (file) {
            file = this.fillBlock(TSOS.Utils.hexFromString);
            var temp;
            var mbr;
            var nextBlock;
            for (var i = 0; i < this.sectors; i++) {
